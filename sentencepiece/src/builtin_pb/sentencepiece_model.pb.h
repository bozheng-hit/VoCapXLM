...
class TrainerSpec PROTOBUF_FINAL :
 ...
 public:
  ...
  // optional string vocab_path = 50;
  bool has_vocab_path() const;
  private:
  bool _internal_has_vocab_path() const;
  public:
...
// optional string vocab_path = 50;
inline bool TrainerSpec::_internal_has_vocab_path() const {
  bool value = (_has_bits_[1] & 0x00000010u) != 0;
  return value;
}
inline bool TrainerSpec::has_vocab_path() const {
  return _internal_has_vocab_path();
}
inline void TrainerSpec::clear_vocab_path() {
  vocab_path_.ClearToEmpty();
  _has_bits_[1] &= ~0x00000010u;
}
inline const std::string& TrainerSpec::vocab_path() const {
  // @@protoc_insertion_point(field_get:sentencepiece.TrainerSpec.vocab_path)
  return _internal_vocab_path();
}
inline void TrainerSpec::set_vocab_path(const std::string& value) {
  _internal_set_vocab_path(value);
  // @@protoc_insertion_point(field_set:sentencepiece.TrainerSpec.vocab_path)
}
inline std::string* TrainerSpec::mutable_vocab_path() {
  // @@protoc_insertion_point(field_mutable:sentencepiece.TrainerSpec.vocab_path)
  return _internal_mutable_vocab_path();
}
inline const std::string& TrainerSpec::_internal_vocab_path() const {
  return vocab_path_.Get();
}
inline void TrainerSpec::_internal_set_vocab_path(const std::string& value) {
  _has_bits_[1] |= 0x00000010u;
  vocab_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void TrainerSpec::set_vocab_path(std::string&& value) {
  _has_bits_[1] |= 0x00000010u;
  vocab_path_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:sentencepiece.TrainerSpec.vocab_path)
}
inline void TrainerSpec::set_vocab_path(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[1] |= 0x00000010u;
  vocab_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:sentencepiece.TrainerSpec.vocab_path)
}
inline void TrainerSpec::set_vocab_path(const char* value,
    size_t size) {
  _has_bits_[1] |= 0x00000010u;
  vocab_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:sentencepiece.TrainerSpec.vocab_path)
}
inline std::string* TrainerSpec::_internal_mutable_vocab_path() {
  _has_bits_[1] |= 0x00000010u;
  return vocab_path_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TrainerSpec::release_vocab_path() {
  // @@protoc_insertion_point(field_release:sentencepiece.TrainerSpec.vocab_path)
  if (!_internal_has_vocab_path()) {
    return nullptr;
  }
  _has_bits_[1] &= ~0x00000010u;
  return vocab_path_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TrainerSpec::set_allocated_vocab_path(std::string* vocab_path) {
  ...
  vocab_path_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), vocab_path,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:sentencepiece.TrainerSpec.vocab_path)
}
